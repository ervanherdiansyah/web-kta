            ...
            <div class="col-12 ">
                <div class="card mb-4 ">
                    <div class="card-header pb-0">
                        <h6 class="d-lg-none">Data Guru</h6>
                        <div class="d-flex align-items-center">
                            <h6 class="d-none d-lg-block">Data Guru</h6>
                            <div class="d-flex flex-wrap align-items-center ms-auto gap-2">
                                <a href="{{ url('/dashboard/guru/export') }}"
                                ...
                                <tbody>
                                    @foreach ($guru as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">{{ $item->nip }}</p>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('/dashboard/guru/create') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
    ...
    <div class="modal fade" id="import" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('/dashboard/guru/import') }}" method="Post" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="example-text-input" class="form-control-label">Import Data Guru</label>
        ...
        <div class="modal fade" id="updatepassword{{ $item->id }}" tabindex="-1"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ url('/dashboard/guru/update/' . $item->id) }}" method="POST"
        ...
        <div class="modal fade" id="delete{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ url('/dashboard/guru/destroy/' . $item->id) }}" method="Post">
                            @csrf
                            @method('DELETE')

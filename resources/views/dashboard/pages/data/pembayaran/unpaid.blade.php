...
@section('title', 'Unpaid Pembayaran')
@section('css')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('/dashboard/pembayaran-unpaid/create') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
...
<div class="modal fade" id="update{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ url('/dashboard/pembayaran/update/' . $item->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="user_id" class="form-control" type="text" value="{{ $item->user->name }} ">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="example-text-input" class="form-control-label">Jumlah
                                    pembayaran</label>
                                <input name="jumlah_pembayaran" class="form-control" type="text" value="{{ $item->jumlah_pembayaran }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="status" class="form-control" type="text" value="{{ $item->status }}">
                            </div>
                        </div>
    ...
    <script>
        ...
        function loadData() {
            $('#myTable').DataTable({
                ...
                ordering: true,
                ajax: {
                    url: "{{ url('/dashboard/pembayaran-unpaid') }}",
                },
                columns: [{
                        data: "user_id",
                        name: "user_id"
                            ...
                            <div class="modal fade" id="delete${data.id}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ url('/dashboard/pembayaran-unpaid/destroy/') }}/${data.id}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <p>Apakah anda yakin ingin menghapus data ini?</p>
                                                <div class="modal-footer">
                            ...
                            <div class="modal fade" id="update${data.id}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ url('/dashboard/pembayaran-unpaid/update/') }}/${data.id}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">

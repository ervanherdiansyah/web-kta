                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="form-delivery" action="{{ url('/peserta/payment') }}"
                                ...
                                <form id="form-pickup" action="{{ url('/peserta/payment') }}"
                    ...
                    <div class="card">
                        <div class="card-header pb-0 pt-3 d-flex" style="background-color: rgba(250, 247, 247, 0.8);">
                            ...
                            <div style="margin-left: auto">
                                <a href="{{ url('/peserta/cetak-kta') }}" target="_blank" class="btn btn-primary">Cetak
                                    PDF</a>
                            </div>
                        </div>
                                    ...
                                    <div class="card bg-dark text-white">
                                        ...
                                        <div class="card-img-overlay">
                                            <div class="align-items-center">
                                                ...
                                                <div class="school">
                                                    <p class="mb-0 text">{{ $dataForm->asal_sekolah }}
                                                    </p>
                                                </div>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = "{{ url('/peserta/biodata') }}";
                    }
                });
            });
        </script>
...
@push('js-payment')
    ...
    <script>
        ...
        function submitForm(form, formName) {
            ...
            axios.post('/peserta/payment', formData)
            ...
            if (snapToken && snapToken.trim() !== "") {
                snap.pay(snapToken, {
                    onSuccess: function(result) {
                        ...
                        window.location.href = '/peserta/kta';
                    },
    ...
    <script type="text/javascript">
        $(function() {
            $('.courier-code').click(function() {
                ...
                $.ajax({
                    url: "/peserta/orders/shipping-fee",
                    method: "POST",
                    data: {

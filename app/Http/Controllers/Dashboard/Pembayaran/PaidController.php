...
class PaidController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $data = Pembayaran::with('user', 'provinsi', 'kota')->where('status', 'Paid')->latest()->get();
        ...
        return view('dashboard.pages.data.pembayaran.paid');
    }
    public function store(Request $request)
    {
        ...
        return redirect('/dashboard/pembayaran-paid');
        // try {

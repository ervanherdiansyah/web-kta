...
class UnpaidController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $data = Pembayaran::with('user', 'provinsi', 'kota')->where('status', 'Unpaid')->latest()->get();
        ...
        return view('dashboard.pages.data.pembayaran.unpaid');
    }
    public function store(Request $request)
    {
        ...
        return redirect('/dashboard/pembayaran-unpaid');
        // try {
